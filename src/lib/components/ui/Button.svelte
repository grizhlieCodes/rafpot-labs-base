<script module lang="ts">
	...
	export const clickableStyles = {
		base: 'cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap border border-solid shadow-sm overflow-hidden transition-all duration-(--duration-global-cols) ease-in-out rounded-base font-ui',
		sizeOptions: {
			small: { button: 'px-3 py-1.5 text-sm' },
			base: { button: 'px-4 py-1.5 text-md' },
			large: { button: 'px-4 py-2 text-base' }
		},
		variantBase: {
			...
			ghost: 'bg-transparent text-surface-12 dark:text-surface-5 border-transparent shadow-none [&.link-active]:bg-surface-3 dark:[&.link-active]:bg-surface-13 [&.link-active]:font-semibold',
		...
		variantHover: {
			...
			baseInvert: 'not-[.toggled]:hover:bg-surface-16 dark:not-[.toggled]:hover:bg-surface-1 not-[.toggled]:hover:border-surface-16 dark:not-[.toggled]:hover:border-surface-1',
			primary: 'not-[.toggled]:hover:bg-primary-15 dark:not-[.toggled]:hover:bg-primary-14 not-[.toggled]:hover:text-primary-1 not-[.toggled]:hover:border-primary-11 dark:not-[.toggled]:hover:border-primary-13',
			secondary: 'not-[.toggled]:hover:bg-secondary-10 dark:not-[.toggled]:hover:bg-secondary-12 not-[.toggled]:hover:border-secondary-11 dark:not-[.toggled]:hover:border-secondary-11',
			danger: 'not-[.toggled]:hover:bg-danger-11 dark:not-[.toggled]:hover:bg-danger-12 not-[.toggled]:hover:border-danger-11 dark:not-[.toggled]:hover:border-danger-11',
			outline: 'not-[.toggled]:hover:bg-surface-3 dark:not-[.toggled]:hover:bg-surface-14 not-[.toggled]:hover:border-surface-6 dark:not-[.toggled]:hover:border-surface-12',
...
<script lang="ts">
	...
	let buttonClass = $derived(cn(clickableStyles.base, sizeConfig.button, clickableStyles.variantBase[variant], clickableStyles.variantHover[variant], className));
</script>
